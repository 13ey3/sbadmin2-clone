...
var sidebarToggleTop = document.body.querySelector('#sidebarToggleTop');
var sidebar = document.body.querySelector('.sidebar');
var scrollOnTop = document.body.querySelector('.scroll-to-top');
...
var scrollToTop = function scrollToTop() {
  if (!scrollOnTop) return false;
  scrollOnTop.style.opacity = window.scrollY === 0 ? '0' : '1';
};
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkbs5_template"] = self["webpackChunkbs5_template"] || [];
